...
const Contract = require('./artifacts/src/contracts/factory.sol/stakingContract.json');
...
async function main() {
  ...
  async function getSetting(fcnName) {
    const functionCallAsUint8Array = await encodeFunctionCall(fcnName, [0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2]);
  ...
  const data = await getSetting('stakes');
